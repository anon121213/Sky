...
namespace Sky {
	...
	public:
		...
		std::string ToString() const override {
			std::stringstream ss;
			ss << "KeyPressedEvent: " << static_cast<int32_t>(m_Key) << " (" << m_RepeatCount << " repeats)";
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "KeyReleasedEvent: " << static_cast<int32_t>(m_Key);
			return ss.str();
		}
	...
	public:
		...
		std::string ToString() const override {
			std::stringstream ss;
			ss << "KeyTypedEvent: " << static_cast<int32_t>(m_Key);
			return ss.str();
		}
